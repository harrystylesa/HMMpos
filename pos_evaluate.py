...
if __name__ == '__main__':
    ...
    path = './data/'
    refs = open(path + 'test_pos1.txt', encoding='utf-8').readlines()
    output = []
    cads = open(path + 'test_cws1.txt_seg2.txt_HMMpos.txt', encoding='utf-8').readlines()
    word_precision, word_recall, word_fmeasure, tag_precision, tag_recall, tag_fmeasure, word_tnr, tag_tnr = score(refs,
                                                                                                                   cads,
                                                                                                                   verbose=True)
